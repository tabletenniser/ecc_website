...
(function($) {
	...
	Calendar.prototype._render = function() {
		...
		switch(this.options.view){
			...
			case 'home_page':
			case 'agenda':
				data.events = this.getEventsAll();
				break;
			case 'details':
				data.event = this.getEventsAll()[0];
			   	break;
		}
		
		//calculate into hours and minutes
		switch(this.options.view) {
			case 'agenda':
			case 'month':
			case 'details':
	...
	Calendar.prototype._update_details = function(){	
		
			
	};
	Calendar.prototype._update_home_page = function(){
	...
	Calendar.prototype.getEventsAll = function(){
