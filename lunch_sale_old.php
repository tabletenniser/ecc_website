...
<h3 style="text-align:center; font-weight:normal; font-size:35px;line-height:100px"> We offers <span style="font-weight:bold;color:rgb(115,0,127);">Cheap Convenient Delicious </span>lunch boxes</br> Every Monday and Thursday 12pm-1pm Galbrieth Building Lobby	</h3>
...
<h3>Lunch Purchase<br/><br/></h3>
	...
	<form class="buy_lunch_form" fole="form" method="POST">
		...
		$name=$order."_name";
		?>
			<div class="lunch_order_container container col-md-3 col-sm-12">
				<img src=<?php echo "./images/lunch/".$food["img"]?>><br/>
				Name: <span id="<?php echo $name?>"><?php echo $food["food"]?></span><br/>
				Price: <?php echo $food["price"]?><br/>
				Order: <select class="form-control" type="<?php echo $order?>" name="<?php echo $order?>" id="<?php echo $order?>" required="true">
		...
		<?php } ?>	
			...
			<br/><div class="form_input_container container col-md-8 col-sm-12">
				...
				<div class="center"><label class="error" for="email_number" id="email_error">This field is required.</label></div><br/>					
			</div>
			<div class="form_input_container container col-md-6 col-sm-12">
				...
				<div class="center"><label class="error" for="date_of_meal" id="date_of_meal_error">This field is required.</label></div><br/>		
			</div>
			<input id="buy_lunch_submit" type="button" class="form-control" value="Submit" style="background-color:#DFF; margin-left:20%; margin-right:20%; width:60%"></input>			
		</div>
	</form>
	</div>
</div>
...
<div class="container col-md-12 col-sm-12">
<br/><br/><h3>Check / Cancel a Meal Purchase</h3>
	<form class="check_lunch_form" fole="form" method="POST">
		<div class="form-group">
			Please enter your student number here: <input class="form-control" type="text" name="student_number_check" id="student_number_check" required="true">
			...
			<input id="check_lunch_button" type="button" class="form-control" value="Check" style="background-color:#DFF; margin-left:20%; margin-right:20%; width:60%"></input>	
